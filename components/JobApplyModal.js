...
const JobApplyModal = ({ isVisible, toggleFunction, confirmFunction, jobTitle, salary, health_impact, desc, disable, requiredSkills }) => {
...
return (
    <Modal isVisible={isVisible} style={styles.modalContainer}>
      ...
      <Text style={[styles.text, {color: '#51330B', fontSize: 25}]}>Apply for {jobTitle}? </Text>
      </View>
        <View style={styles.userInfoContainer}>
            ...
            <View style={styles.textContainer}>
                ...
                <Text style={styles.text}>Health impact: {health_impact} </Text>
                <Text style={styles.text}>Skills needed: {requiredSkills} </Text>
        ...
        <View style={styles.userInfoContainer}>
        <Text style={[styles.text, {color: '#51330B', fontSize: 25}]}>Decsription</Text>
