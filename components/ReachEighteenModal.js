...
const ReachEighteenModal = ({ isVisible, toggleFunction }) => {
      ...
      <Text style={{fontFamily: 'Itim_400Regular', fontSize: 35, color: 'white', fontWeight: '600'}}>Congratulation!</Text>    
        ...
        <View style={styles.userInfoContainer}>
            <View style={styles.textContainer}>
                <Text style={styles.text}>You receive some money from parent</Text>
            </View>
        </View>
        ...
        <View style={styles.userInfoContainer}>
            ...
            <View style={styles.textContainer}>
              <Text style={styles.text}>+10,000 gold</Text>
            </View>
        </View>
...
export default ReachEighteenModal;