...
const ResetModal = ({ isVisible, toggleFunction, confirmFunction }) => {
      ...
      <View style={styles.modal}>
        ...
        <View style={styles.userInfoContainer}>
            <View style={styles.textContainer}>
                <Text style={styles.text}>Game will reset!!!</Text>
            </View>
        </View>
        ...
        <View style={[styles.BottomButtons, {alignSelf: 'center'}]}>
                  ...
                  <ButtonOrange onPress={() => {
                    ...
                    <Text style={{color: 'white', fontSize: 30, fontFamily: 'Itim_400Regular'}}>Reset</Text>
